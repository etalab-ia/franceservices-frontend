...
const faq = {
		...
		questions: [
			...
			},
			{
				...
				content: (
					<div>
						<p>
							Trois bases de connaissances ont été mobilisées pour entraîner (fine-tuning) Albert :
						</p>
						<ul>
						...
						<p>
							Llama2-chat, le grand modèle de langue initial sur lequel repose Albert, a été
							pré-entraîné sur des sources d’information publiquement accessibles.
						</p>
					</div>
				),
			},
			...
			},
			{
				...
				content: (
					<div>
						<p>
							Les performances d’Albert sont régulièrement évaluées : à chaque nouvelle version de
							l’outil, Albert doit passer un QCM, établi sur le périmètre des France services. Ce
							QCM permet de donner une note au modèle, qui permet de suivre l’évolution des
							performances des différentes versions d’Albert.
						</p>
						<p style={{ paddingTop: 15 }}>
							De plus, des campagnes d’évaluation seront fréquemment menées avec les agents publics
							utilisant l’outil avant de comprendre précisément les forces et faiblesses d’Albert,
							et l’améliorer le modèle en conséquence.
						</p>
					</div>
				),
			},
	...
	albertUsage: {
		...
		questions: [
				...
				content: (
					<div>
						<p className="fr-mb-3w">
							A partir de la page d’accueil, cliquer sur “Préparer un rendez-vous”. Sur cette page,
							vous êtes invité à décrire la situation de l’usager que vous recevez. Veillez à
							respecter les bonnes pratiques pour décrire la situation indiquée sous le champ
							associé. Vous pouvez également indiquer les thèmes associés à la situation et les
							opérateurs concernés.{" "}
						</p>
						<p className="fr-mb-3w">
							Une fois la situation de l’usager décrite, cliquez sur le bouton “générer la page
							rendez-vous” pour accéder aux informations répondant à la situation et votre question.
						</p>
						<p>
							Le tutoriel “Comment utiliser la fonction "Préparer un RDV” partagé sur Osmose vous
							guide pas à pas.
						</p>
					</div>
				),
					...
					<div>
						...
						<ul>
							<li className="fr-mb-1w">
								&bull; D’utiliser de données personnelles : ces informations ne sont pas utiles pour
								permettre à Albert de vous apporter une réponse
							</li>
							<li className="fr-mb-1w">
								&bull; D’utiliser seulement des mots clés : Albert ne fonctionne pas comme un moteur
								de recherche plus traditionnel
							</li>
							<li>
								&bull; Préciser sa demande : Albert a besoin d’informations précises pour apporter
								une réponse pertinente
							</li>
							<li className="fr-mb-1w">
								&bull; Formuler une question : Albert a besoin que vous lui formuliez une question
								claire
							</li>
							<li className="fr-mb-1w">
			...
			},
			{
				...
				content: (
					<div>
						...
						<ul>
							<li>
								&bull; Résultat : une synthèse de différentes sources d’information probablement
								pertinentes par rapport à la situation que vous avez décrite.
							</li>
							<li>
								&bull; Sources du résultat : les sources d’information utilisées pour générer le
								résultat. Les textes apparaissant ici sont directement tirés des sources
								documentaires associées.
							</li>
							<li>
								&bull; Pour aller plus loin : les fiches service-public.fr les plus pertinentes par
								rapport à la situation que vous avez décrite.
							</li>
							<li>
								&bull; Liens pratiques : des liens vers des outils, simulateurs ou téléservices en
								lien avec la situation que vous avez décrite.
							</li>
							<li>
								&bull; Questions fréquentes : des questions fréquemment posées en lien avec la
			...
			{
				label: "Quelles sont les données collectées par Albert et comment sont-elles utilisées ?",
				content: (
					<div>
						...
						<ul className="fr-mb-3w">
							<li>
								...
								comprennent des données officielles que sont les fiches service-public.fr, les
								fiches travail-emploi, et la documentation France services.
							</li>
							<li>&bull; Des données d’utilisation :</li>
							<ul>
								<li>
									&bull; Les fiches rendez-vous déjà générées sont conservées sur le compte où elles
									ont été saisies afin de pouvoir être retrouvées facilement par l’agent qui les a
									préparées,
								</li>
								<li>
									&bull; Les questions saisies dans l’outil, à des fins d’archivage par l’agent et
									d’amélioration des performances de l’outil via un réentraînement.
								</li>
								<li>
									&bull; Les retours “Positif/Négatif” que vous saisissez sont conservés dans les
									serveurs de l’outil afin de pouvoir l’améliorer.
								</li>
							</ul>
						</ul>
						<p className="fr-mb-3w">
							Albert collecte-t-il les données personnelles des usagers reçus par les France
							services ?
						</p>
						<p className="fr-mb-3w">
							La seule façon dont des données personnelles d’usagers reçus par les France services
							peuvent être collectées par Albert est si elles sont entrées dans le champ de
							description de la situation de l’usager.
						</p>
						<p className="fr-mb-3w">
							A ce titre, il est fortement déconseillé d’utiliser des données personnelles pour
							décrire la situation de l’usager. Celles-ci ne sont en effet pas utiles pour le
							fonctionnement et l’efficacité d’Albert. Par exemple, si une allocation familiale
							requiert une condition d’âge (eg. avoir plus de 25 ans) pour y avoir accès, il est
							plus judicieux d’indiquer dans la description que la personne a plus de 25 ans plutôt
							que sa date de naissance précise.
						</p>
						<p className="fr-mb-3w">Qui est responsable de l’utilisation des données ?</p>
						<p>
							La Direction Interministérielle du Numérique (DINUM) est l’organisme responsable des
							traitements de données associés à Albert.
						</p>
					</div>
				),
			},
