import { meetingExamplesTitle, meetingParagraph, meetingPromptExamples } from "../../constants/meeting";
		...
		<>
			<GlobalColContainer>
				...
				<p className={`fr-my-2w`} onClick={handleToggleAll}>
					...
					<span className={`fr-icon-arrow-${isAccordionOpen ? 'up' : 'down'}-s-line fr-my-2w`}></span>
				</p>
