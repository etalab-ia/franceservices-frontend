export const askingSpecificDocumentation = "Voulez-vous utiliser une base documentaire spécifique ?"
...
export const ressourcesChoiceButton = (choice) =>
	`Bouton du choix de la base documentaire à utiliser (${choice}).`
