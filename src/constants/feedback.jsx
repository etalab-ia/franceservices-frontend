...
export const	feedbackButtonsChoice = (button) => `Bouton permettant de sélectionner le retour d'expérience "${button}".`;
...
export const	satisfactionButton = (type) => `Bouton pour indiquer que la réponse générée est ${type}`;
