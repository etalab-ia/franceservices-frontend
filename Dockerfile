...
ARG VITE_API_URL VITE_ENVIRONMENT_NAME VITE_MODEL_NAME VITE_MODEL_MODE VITE_MODEL_TEMPERATURE VITE_MATOMO_URL VITE_KEYCLOAK_AUTHORITY VITE_KEYCLOAK_CLIENT_ID
